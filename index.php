                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            <span><img width="180" height="230" src="img/<?php echo $row['anh'];?>" alt="" /></span>
                            <div class="caption">
                                <h4><b><span style="color: blue"><?php echo $row['tensach'];?></span> </b></h4>
                                <p><?php echo $row['tacgia'];?> </p>
                                <p>Giá: <b><span style="color: red"><?php echo $row['gia'];?></span></b>  </p>         
                                <p><a href="./giohang/addgio.php?masach=<?php echo $row['masach'];?>&tensach=<?php echo $row['tensach'];?>&gia=<?php echo $row['gia'];?>&tacgia=<?php echo $row['tacgia'];?>&anh=<?php echo $row['anh'];?> " class="btn btn-success" role="button">Đặt mua</a> 
                                    <a href="chitietsach.php?masach=<?php echo $row['masach'];?>&tensach=<?php echo $row['tensach'];?>" class="btn btn-primary" role="button">Chi tiết</a></p>
                            </div>
                        </div>
                    </div>
                      <?php } ?>           
